...
import 'package:learn_slicing/datas/icons.dart';
import 'package:learn_slicing/theme.dart';
                ...
                children: [
                  Flexible(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          SvgPicture.asset('assets/logo/search.svg',
                      ...
                      children: [
                        ...
                        Positioned(
                            ...
                            child: Container(
                              ...
                              clipBehavior: Clip.hardEdge,
                              child: SvgPicture.asset('assets/logo/goclub.svg',
                                  color: blue3),
                            ))
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            padding: const EdgeInsets.symmetric(
                                horizontal: 6,
                                vertical: 4), // Kurangi padding vertikal
                            decoration: BoxDecoration(
                              color: Colors.white,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('Klik & cek riwayat',
                                    style: regular12_5.copyWith(color: green1)),
                              ],
                            ),
                          )
                        ],
                ...
                child: Stack(
                  children: [
                    Positioned(
                        ...
                        top: 4,
                        bottom: 4,
                        child: SvgPicture.asset('assets/logo/dots.svg')),
                    Container(
                      padding: const EdgeInsets.symmetric(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text('117 XP lagi ada Harta Karun'),
                              const SizedBox(
                                height: 8,
                              ),
                              Container(
